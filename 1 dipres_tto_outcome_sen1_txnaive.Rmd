...
table(df$tto_completo_tratat0_t1)
a <- table(df$treat_t1)
round(prop.table(a)*100,2)
...
# Outcome regression dataset + filter sensitivitiy analysis
```{r}
...
save(df_ipcw_t2, file = "df_ipcw_t2_v2_sen.Rdata")
```
...
# Pr actual treatment
density_plot_t1_1 <- density(df_model$pr_tt_t1[df_model$treat_time_t1_v1 == "3 or less months"], na.rm = TRUE)
density_plot_t1_2 <- density(df_model$pr_tt_t1[df_model$treat_time_t1_v1 == "4 to 7 months"], na.rm = TRUE)
density_plot_t1_3 <- density(df_model$pr_tt_t1[df_model$treat_time_t1_v1 == "8 or more months"], na.rm = TRUE)
density_plot_t1_4 <- density(df_model$pr_tt_t1[df_model$treat_time_t1_v1 == "Currently in treatment"], na.rm = TRUE)
...
# Check density across censored and uncensored T2
density_plot_t1_1 <- density(df_outcome$w_t_595[df_outcome$treat_time_t1_v1 == "3 or less months"], na.rm = TRUE)
density_plot_t1_2 <- density(df_outcome$w_t_595[df_outcome$treat_time_t1_v1 == "4 to 7 months"], na.rm = TRUE)
density_plot_t1_3 <- density(df_outcome$w_t_595[df_outcome$treat_time_t1_v1 == "8 or more months"], na.rm = TRUE)
density_plot_t1_4 <- density(df_outcome$w_t_595[df_outcome$treat_time_t1_v1 == "Currently in treatment"], na.rm = TRUE)
...
# Pr actual treatment
density_plot_t1_1 <- density(df_outcome$pr_tt_t1[df_outcome$treat_time_t1_v1 == "3 or less months" & !is.na(df_outcome$w_t_595)], na.rm = TRUE)
density_plot_t1_2 <- density(df_outcome$pr_tt_t1[df_outcome$treat_time_t1_v1 == "4 to 7 months" & !is.na(df_outcome$w_t_595)], na.rm = TRUE)
density_plot_t1_3 <- density(df_outcome$pr_tt_t1[df_outcome$treat_time_t1_v1 == "8 or more months" & !is.na(df_outcome$w_t_595)], na.rm = TRUE)
density_plot_t1_4 <- density(df_outcome$pr_tt_t1[df_outcome$treat_time_t1_v1 == "Currently in treatment" & !is.na(df_outcome$w_t_595)], na.rm = TRUE)
...
# Pr actual treatment
density_plot_t1_1 <- density(df_model$pr_trc_t1[df_model$treat_comp_t1_v1 == "Not Completed"], na.rm = TRUE)
density_plot_t1_2 <- density(df_model$pr_trc_t1[df_model$treat_comp_t1_v1 == "Completed"], na.rm = TRUE)
density_plot_t1_3 <- density(df_model$pr_trc_t1[df_model$treat_comp_t1_v1 == "Currently in treatment"], na.rm = TRUE)
...
# Check density across censored and uncensored T2
density_plot_t1_1 <- density(df_outcome$w_t_595[df_outcome$treat_comp_t1_v1 == "Not Completed"], na.rm = TRUE)
density_plot_t1_2 <- density(df_outcome$w_t_595[df_outcome$treat_comp_t1_v1 == "Completed"], na.rm = TRUE)
density_plot_t1_3 <- density(df_outcome$w_t_595[df_outcome$treat_comp_t1_v1 == "Currently in treatment"], na.rm = TRUE)
...
# Pr actual treatment
density_plot_t1_1 <- density(df_outcome$pr_trc_t1[df_outcome$treat_comp_t1_v1 == "Not Completed" & !is.na(df_outcome$w_t_595)], na.rm = TRUE)
density_plot_t1_2 <- density(df_outcome$pr_trc_t1[df_outcome$treat_comp_t1_v1 == "Completed" & !is.na(df_outcome$w_t_595)], na.rm = TRUE)
density_plot_t1_3 <- density(df_outcome$pr_trc_t1[df_outcome$treat_comp_t1_v1 == "Currently in treatment" & !is.na(df_outcome$w_t_595)], na.rm = TRUE)
